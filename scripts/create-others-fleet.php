...
try {
    ...
    $service = othersCliService($options['database-config'] ?? null);
    $fleet = $service->createFleet(
    ...
    echo 'Created Others fleet ' . $fleet['public_id'] . ' with fully fueled mothership ' . $fleet['ship']['public_id'] . ".\n";
