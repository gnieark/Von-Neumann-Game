...
final class Manny
{
    ...
    public const WAITING_FOR_SPACE_SINCE_PAYLOAD_KEY = 'waitingForSpaceSince';
    ...
    public function __construct(
        ...
        public ?string $reservedCargoType,
        public float $reservedCargoSpace,
        public ?int $reservedStorageContainerId,
