...
- Missiles : la recette Manny `missile` consomme 0,20 ECE de métaux et 0,10 ECE de composés carbonés en une heure pour une sortie de 0,05 ECE. Le lancement depuis une sonde réserve une Manny pendant une minute ; le lancement Others est planifié à échéance immédiate. Dans les deux cas, seuls les passages du scheduler créent puis résolvent le projectile.
